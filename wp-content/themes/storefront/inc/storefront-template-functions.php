	...
	function storefront_primary_navigation() {
		...
		<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_html_e( 'Primary Navigation', 'storefront' ); ?>">
			<?php 
				...
				// echo '<a href="/shop/" class="cta">Shop the collection</a>';
			?>
...
if ( ! function_exists( 'novon_shop_loop_before' ) ) {

	function novon_shop_loop_before() {

		echo '<section class="novon-shop-loop">';
		echo '<button class="mb-filters js-mb-filters">Filters</button>';
		
	}
}


if ( ! function_exists( 'novon_shop_loop_after' ) ) {

	function novon_shop_loop_after() {
...
if ( ! function_exists( 'novon_homepage_content' ) ) {
	/**
	 * Display Product Categories
	 * Hooked into the `homepage` action in the homepage template
	 *
	 ...
	 * @return void
	 */
	function novon_homepage_content() {

		get_template_part( 'content', 'novon' );
