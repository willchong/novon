	...
	class Storefront {
		...
		public function scripts() {
			...
			$google_fonts = apply_filters( 'storefront_google_font_families', array(
				'barlow-semi-condensed' => 'Barlow+Semi+Condensed:400,700',
			...
			wp_enqueue_style( 'modal-style', get_template_directory_uri() . '/novon/css/modal-video.min.css', '', $storefront_version );
			...
			wp_enqueue_script( 'modal-script', get_template_directory_uri() . '/novon/js/jquery-modal-video.min.js', array( 'jquery' ), '20120206', true );
