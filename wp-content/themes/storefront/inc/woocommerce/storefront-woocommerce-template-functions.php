...
if ( ! function_exists( 'storefront_novon_product_wrapper' ) ) {
	...
	function storefront_novon_product_wrapper() {
		...
		echo '<div class="cta-wrapper"><a href="'.get_site_url().'/shop/" class="cta">Back to Collection</a></div>';
	}
}
...
if ( ! function_exists( 'storefront_novon_design_your_own' ) ) {
	...
	function storefront_novon_design_your_own() {
		...
		if (!is_product_category('pre-designed-bracelets')) {
...
if ( ! function_exists( 'storefront_before_category_content' ) ) {
	...
	function storefront_before_category_content() {
		...
		<div class="novon-category">
			<div class="cta-wrapper"><a href="<?php echo get_site_url(); ?>/shop/" class="cta">Back to Collection</a></div>
