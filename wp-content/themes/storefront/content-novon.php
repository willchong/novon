...
<section class="novon-wrap">
    ...
    <section class="intro">
        ...
        <h1><?php echo $fields['headline']; ?></h1>
        <div class="homepage-slides">
            <?php foreach ($fields['slides'] as $slide): ?>
                <img src="<?php echo $slide['image']['url']; ?>" class="hidden" alt="">
            <?php endforeach; ?>
        </div>
    ...
    <section class="post-intro">
        <div class="description">
            <h4><?php echo $fields['video_headline']; ?></h4>
            <div class="embed">
                <iframe src="https://player.vimeo.com/video/<?php echo $fields['vimeo_video_id']; ?>?byline=0&title=0&portrait=0" frameborder="0" allow="fullscreen" allowfullscreen></iframe>
            </div>
            <a href="<?php echo get_site_url(); ?>/design-your-own/" class="cta inverse">Design your own</a>
        </div>
    </section>
    ...
    <section class="modular" id="modular">
        ...
        <div class="panel">
            <div class="steps">
                ...
                <a href="<?php echo get_site_url(); ?>/design-your-own/" class="cta">Design your own</a>
                <a class="cta js-modal-btn" data-video-id="7a3pn6-KYvU">Watch video</a>
            </div>
            <div class="earrings">
   ...
   <!--  <section class="bio">
    ...
    <section class="shop">
        ...
        <a href="<?php echo get_site_url(); ?>/shop/" class="cta inverse bigger transparent">See Products</a>
    </section>
