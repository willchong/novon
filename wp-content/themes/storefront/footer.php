...
?>
	...
	<footer>
	    <ul>
	        ...
	        <li><a href="<?php echo get_site_url(); ?>/where-to-buy/">Where to Buy</a></li>
	        ...
	        <li><a href="<?php echo get_site_url(); ?>/return-warranty-policy/">Return &amp; Warranty Policy</a></li>
	    </ul>
	    <ul>
	    ...
	    <ul>
	        ...
	        <li><a class="no-highlight" target="_blank" href="https://twitter.com/novonjewelry"><img src="<?php echo get_template_directory_uri(); ?>/novon/images/icon-twitter-1.svg" alt=""></a></li>
